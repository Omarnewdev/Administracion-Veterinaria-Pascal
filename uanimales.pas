...
begin
  ...
  while not eof(dbMascota) do begin
    read(dbMascota,buscar);
    contenido:=TMascota.Create(buscar.FatrID,buscar.FatrNombre,buscar.FatrGeneroEspecifico,buscar.FatrEdad,buscar.FatrGestacionEsp,buscar.FatrEspecie,buscar.FatrRaza);
    result.agregar(contenido);
  end;
